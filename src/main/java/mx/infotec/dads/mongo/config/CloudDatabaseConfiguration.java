package mx.infotec.dads.mongo.config;
...
@Configuration
@EnableMongoRepositories("mx.infotec.dads.mongo.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("mx.infotec.dads.mongo.config.dbmigrations");
